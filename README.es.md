# <img src="media/branding/icon-32.png" alt="Icono de ShipOne" width="28" /> ShipOne

ShipOne es una extensión de VS Code para crear, organizar y terminar proyectos con contexto claro.

Mantiene visible el siguiente paso, preciso el estado del proyecto y baja la fricción al volver al trabajo.

<p align="center">
  <img src="media/branding/banner.png" alt="Banner de ShipOne" />
</p>

<p align="center">
  <a href="https://marketplace.visualstudio.com/items?itemName=pdpunto.shipone">
    <img src="https://img.shields.io/visual-studio-marketplace/v/pdpunto.shipone?color=0f172a&label=Marketplace" alt="Insignia de Marketplace" />
  </a>
  <a href="https://github.com/pdpunto/shipone">
    <img src="https://img.shields.io/badge/GitHub-pdpunto%2Fshipone-111827?logo=github" alt="Insignia de GitHub" />
  </a>
</p>
...
- Ritmo: cambios pequenos, versionados y faciles de seguir
...
![Vista general de ShipOne](docs/assets/screenshots/01-overview.png)

### Proyecto activo

![Proyecto activo de ShipOne](docs/assets/screenshots/02-active-project.png)

### Focus mode

![Focus mode de ShipOne](docs/assets/screenshots/04-focus-mode.png)
...
5. Usa la vista `ShipOne` o `ShipOne: Create` para crear un proyecto.
6. Escribe `nextAction` y trabaja desde la misma vista.
7. Si un proyecto se queda atascado, usa `Freeze project` o `Weekly review`.

## Comandos utiles

- `ShipOne: Create` - crea proyecto nuevo
- `ShipOne: Open` - abre un proyecto
- `ShipOne: Search` - filtra proyectos por nombre o etiqueta
- `ShipOne: Focus` - entra en focus mode
- `ShipOne: Weekly review` - revisa el estado semanal
- `ShipOne: Generate project context` - crea un resumen listo para retomar
- `ShipOne: Delete project` - borra un proyecto con confirmacion
- `ShipOne: STATUS.md` - sincroniza el archivo de estado
- `ShipOne: Connect GitHub` - conecta GitHub para publicar repos
